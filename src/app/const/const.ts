...
export const NIVELESPORMODALIDADMATRICULA: { [key: string]: string[] } = {
 ...
 const ICONO_SNU = '🎓'
 const ICONO_FORMACION_PROFESIONAL = '🧰'
...
export const ICONOS_NIVELES: { [key: string]: string } = {
  ...
  [NIVEL_SNU]: ICONO_SNU,
  [NIVEL_FORMACION_PROFESIONAL]: ICONO_FORMACION_PROFESIONAL
}

export const ICONOS_COMUN = [
  ICONO_INICIAL,
  ICONO_PRIMARIO,
  ICONO_SECUNDARIO,
  ICONO_SECUNDARIO_5,
...
export const ICONOS_ESPECIAL = [
  ICONO_INICIAL,
  ICONO_PRIMARIO
];

export const ICONOS_ADULTOS = [
  ICONO_PRIMARIO,
  ICONO_SECUNDARIO,
  ICONO_SECUNDARIO,
  ICONO_SECUNDARIO,
  ICONO_FORMACION_PROFESIONAL
];